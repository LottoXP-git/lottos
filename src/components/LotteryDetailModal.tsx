       ...
       <DialogContent className="max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto bg-card border-border p-2.5 sm:p-6 mx-0 sm:mx-auto w-[calc(100vw-1rem)] sm:w-auto rounded-xl">
        <DialogHeader className="space-y-0.5 sm:space-y-1">
          <div className="flex flex-col items-center gap-1.5">
            <DialogTitle className="text-base sm:text-2xl font-bold flex items-center gap-1.5 sm:gap-3 flex-wrap leading-tight justify-center">
              {lottery.name}
            ...
            <ShareButton
              ...
              className="h-8 w-8 sm:h-9 sm:w-9 transition-all duration-200 hover:scale-110 hover:bg-primary/10 hover:text-primary"
            />
          </div>
