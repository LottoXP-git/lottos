...
import { Calendar, Trophy, Users, TrendingUp, Flame, Sparkles, Clover, Heart, CalendarDays, Dribbble, MousePointerClick, Repeat, Info } from "lucide-react";
...
function getSpecialDrawLabel(id: string): string {
  ...
  if (id === "quina") return "QUINA FINAL 5 - ESPECIAL!";
