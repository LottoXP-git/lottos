      ...
      <JsonLd
        data={[
          buildBreadcrumb([
            ...
            { name: "Termos de Uso", url: `${SITE_URL}/termos` },
          ]),
          {
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Termos de Uso — Lottos",
            description:
              "Termos de uso do Lottos: regras, direitos e responsabilidades para uso da plataforma.",
            inLanguage: "pt-BR",
            mainEntityOfPage: `${SITE_URL}/termos`,
      ...
      <main className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="prose prose-sm dark:prose-invert space-y-6 text-muted-foreground">
          ...
          <section className="space-y-2">
            ...
            <p>
              Dúvidas sobre estes termos podem ser enviadas para: <span className="text-foreground font-medium">grupolottoxp@gmail.com</span>
            </p>
          </section>
        </div>
      </main>
